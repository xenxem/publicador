 ...
 public class ControlePrincipal extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(comando.equals("detalhes") || comando2.equals("detalhes") ){
			...
			/* 
			 * Para contar qntas vezes um an�ncio foi acessado
			 * Caso o usu�rio ainda n�o tenha 
			 * recebido um cookie, configura um para controle de acesso ao an�ncio
			 * 			 
			 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(comando.equals("Entrar")){
			...
			//verificando se email do usu�rio j� est� cadastrado na base			
			DAOUsuario daoUsuario = df.getDAOUsuario();
			...
			if(u==null){
				...
				if(u.getStatusValidacao().equals("H")){
					...
					//se n�o tiver cria uma sess�o para o usu�rio
